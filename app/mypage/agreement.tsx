          ...
          {({
            ...
            <ScrollView contentContainerClassName="gap-5 p-5 pb-28">
              ...
              <View className="flex-row gap-2 pb-4">
                <Pressable
                  onPress={submit}
                  className="flex-1 items-center justify-center rounded-xl border border-blue-600 py-3"
                >
                ...
                <Pressable
                  ...
                  className={`flex-1 items-center justify-center rounded-xl py-3 ${
                    canFinalize ? 'bg-blue-600' : 'bg-neutral-300'
                  }`}
                >
                  <Text
                    className={
  ...
  return (
    <SafeAreaView className="flex-1 bg-white" edges={['top']}>
      ...
      <ScrollView contentContainerClassName="gap-4 p-5">
        <View className="gap-1 rounded-2xl bg-blue-50 p-4">
