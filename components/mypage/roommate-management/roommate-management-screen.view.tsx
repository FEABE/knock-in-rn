      ...
      {props.loading ? (
        ...
        <View className="flex-1 items-center justify-center gap-3 px-8">
          ...
          <Text className="text-center text-sm text-neutral-400">
            채팅방에서 최종 룸메이트 제안을 수락하면 합의서와 캘린더를 사용할 수 있어요.
          </Text>
        </View>
      ) : (
        <ScrollView contentContainerClassName="gap-6 px-4 pb-14">
          ...
          >
            ...
            <View className="flex-1">
              ...
              <Text className="text-xs text-[#AAAABA]">청소·소음·공과금 규칙을 함께 정해요</Text>
            </View>
          ...
          <View className="gap-3">
            <View className="flex-row items-center justify-between">
              <Text className="text-base font-bold text-[#17171B]">{props.selectedDate} 일정</Text>
              <Pressable
